...
bool (*GJItemIcon_init)(GJItemIcon*, IconType, int, ccColor3B, ccColor3B, bool, bool, bool, ccColor3B);
bool GJItemIcon_initHook(GJItemIcon* self,
    IconType type, int iconID,
    ccColor3B col1, ccColor3B col2,
    bool un0, bool un1, bool un2,
    ccColor3B col3)
{
    if (type == Player && iconID > 142)
    {
        if (!self->init(type, iconID, col1, col2, un0, un1, un2, col3))
            return false;

        self->init(Player, iconID, col1, col2, un0, un1, un2, col3);
...
{
    //vm_write(0x2ac824, 0x9a);
    //vm_write(0x2ac622, 0x9a);
    //vm_write(0x2ad4d0, 0x9a);
    ...
    photon::utils::do_inline_hook( "_ZN10GJItemIcon4initE10UnlockTypeiN7cocos2d10_ccColor3BES2_bbbS2_", GJItemIcon_initHook, &GJItemIcon_init );
    photon::utils::do_inline_hook("_ZN16MoreOptionsLayer4initEv", MoreOptionsLayer_initHook, &MoreOptionsLayer_init);
